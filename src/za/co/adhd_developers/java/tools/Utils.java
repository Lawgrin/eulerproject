...
//    public static boolean newIsPrime(BigInteger number)
//    {
//        if (number <= 1)
//        {
//            return false;
...
//    private static Hashtable<String, BigInteger> nearestRoot = new Hashtable<>();
//    public BigInteger getSquare(BigInteger number)
//    {
//        if (nearestRoot.get(number.toString()) != null)
//        {
//            return nearestRoot.get(number.toString());
//        }
//
//
//    }
...
//    public static <T extends Number> Pair<T, T> addToFraction(T toAdd, T numerator, T denominator, Comparator<T> comperor) {
//        /*
...
//         */
//
//        T newNumerator = numerator;
//        T newdenominator = denominator;
//
//        if (comperor.compare(numerator, denominator) == -1) {
//            newNumerator = denominator * toAdd;
//        }
//
//    }

    public static Pair<Long, Long> addToFraction(Long toAdd, Long numerator, Long denominator) {
        return new Pair<>((denominator * toAdd) + numerator, denominator);
    }
