...
class Question11 : Question {
    ...
    override fun doWork() {
        ...
        for (row in 0..19) {
            for (col in 0..19) {
                ...
                if (up && right) {
                    num2 = data[row - 1][col + 1]
                    num3 = data[row - 2][col + 2]
                    num4 = data[row - 3][col + 3]
    ...
    override fun printAnswer() {
        println("=================================")
        println("Question 11")
        println("The greatest product of four adjacent numbers is: " + this.answer)
        println("=================================")
    }
}